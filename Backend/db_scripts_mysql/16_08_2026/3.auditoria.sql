...
DECLARE v_Num INT;
    SET v_Num = 1; 
    SELECT IFNULL(MAX(CAST(SUBSTRING(IDAUDITORIA, 4, 10) AS UNSIGNED)), 0) + 1 INTO v_Num FROM AUDITORIA WHERE IDAUDITORIA LIKE 'AUD%';
...
DECLARE v_offset INT DEFAULT 0;
    SELECT COUNT(*) INTO p_TotalRegistros FROM AUDITORIA a LEFT JOIN USUARIO u ON u.IDUSUARIO=a.IDUSUARIO
