...
CREATE TABLE IF NOT EXISTS USUARIO_SUBMODULO_EXCLUIDO (
    ...
    FOREIGN KEY (IDSUBMODULO) REFERENCES SUBMODULO(IDSUBMODULO),
    FECHAREGISTRO    CHAR(8) NULL,
...
CREATE TABLE IF NOT EXISTS COTIZACION (
    ...
    IDFORMAPAGO VARCHAR(50) NULL,
    FOREIGN KEY (IDFORMAPAGO) REFERENCES FORMA_PAGO(IDFORMAPAGO),
    IDTIPOENTREGA VARCHAR(50) NULL,
    FOREIGN KEY (IDTIPOENTREGA) REFERENCES TIPO_ENTREGA(IDTIPOENTREGA),
...
DECLARE v_IDTIPOUSUARIO VARCHAR(50);
    SELECT IDTIPOUSUARIO INTO v_IDTIPOUSUARIO FROM USUARIO
