...
urlpatterns = [
    ...
    path('cupones/', catalogo_views.cupones_mantenedor, name='cupones_mantenedor'),
    path('cupones/<str:id_val>/', catalogo_views.cupones_mantenedor, name='cupones_mantenedor_detail'),
